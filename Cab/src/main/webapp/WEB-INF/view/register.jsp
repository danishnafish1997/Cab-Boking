...
<body bgcolor=CadetBlue>
	...
	<tr><td> Enter LoginID</td><td><input type="text" name=loginid autofocus ></td>
	<td>${login_id_message}</td></tr>
	<tr><td>Password</td><td><input type="password" name=password></td>
	<td>${warning}</td></tr>
	<tr><td>Confirm Password</td><td><input type="password" name=con_password></td></tr>
	<tr><td>User Name</td><td><input type="text" name=userName></td></tr>


	<td>${message}</td></tr>
<tr><td>Address</td><td><input type="text" name=userAddress></td></tr>
	<tr><td>Mobile Number</td><td><input type="text" name=userContactNumber></td></tr>
